...
if "`outcome'" == "lead_police_pc" {
	save "Data/Intermediate/Fig2.dta", replace
}
else if "`outcome'" == "lead_camera_time_city_pc" {
	save "Data/Intermediate/FigA12.dta", replace
}
else if "`outcome'" == "aiXcam" {
	save "Data/Intermediate/FigA13.dta", replace
}
...
use "Data/Intermediate/Fig2.dta", clear
...
use "Data/Intermediate/FigA12.dta", clear
...
use "Data/Intermediate/FigA13.dta", clear
...
save "Data/Intermediate/Fig3.dta", replace


** actually make graph
use "Data/Intermediate/Fig3.dta", clear
keep b s 
...
foreach t in   `"GOVERNMENT"' `"BUSINESS"' `"ALL"' { 
	...
	* col 1 and 2
	...
	save "Data/Intermediate/Fig5_`pre'_`t'.dta", replace
	...
	* col 1 and 2
	...
	regToCoefDataset90 blank 
	save "Data/Intermediate/Fig5_`pre'_`t'_b1.dta", replace
...
local pre = "event"
foreach t in `"GOVERNMENT"' `"BUSINESS"' `"ALL"' {
	use "Data/Intermediate/Fig5_`pre'_`t'.dta", clear
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .3
	ren (beta top bottom) (beta_niv_b12 top_niv_b12 bottom_niv_b12)
	
	merge 1:1 id using "Data/Intermediate/Fig5_`pre'_hat_lasso_`t'.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .1 if !missing(beta1)
	ren (beta1 top bottom) (beta_iv_b12 top_iv_b12 bottom_iv_b12)
	
	merge 1:1 id using "Data/Intermediate/Fig5_`pre'_`t'_b1.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .1 if !missing(beta1)
	ren (beta1 top bottom) (beta_niv_b1 top_niv_b1 bottom_niv_b1)
	
	merge 1:1 id using "Data/Intermediate/Fig5_`pre'_hat_lasso_`t'_b1.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
...
foreach t in   `"GOVERNMENT"' `"BUSINESS"' `"ALL"' { 
	...
	* col 1 and 2
	...
	regToCoefDataset90 blank 
	save "Data/Intermediate/Fig6_`pre'_`t'.dta", replace
	...
	* col 1 and 2
	...
	regToCoefDataset90 blank 
	save "Data/Intermediate/Fig6_`pre'_`t'_b1.dta", replace
...
local pre = "event"
foreach t in `"GOVERNMENT"' `"BUSINESS"' `"ALL"' {
	use "Data/Intermediate/Fig6_`pre'_`t'.dta", clear
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .3
	ren (beta top bottom) (beta_niv_b12 top_niv_b12 bottom_niv_b12)
	
	merge 1:1 id using "Data/Intermediate/Fig6_`pre'_hat_lasso_`t'.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .1 if !missing(beta1)
	ren (beta1 top bottom) (beta_iv_b12 top_iv_b12 bottom_iv_b12)
	
	merge 1:1 id using "Data/Intermediate/Fig6_`pre'_`t'_b1.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .1 if !missing(beta1)
	ren (beta1 top bottom) (beta_niv_b1 top_niv_b1 bottom_niv_b1)
	
	merge 1:1 id using "Data/Intermediate/Fig6_`pre'_hat_lasso_`t'_b1.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .3 if !missing(beta1)
	ren (beta1 top bottom) (beta_iv_b1 top_iv_b1 bottom_iv_b1)
...
foreach t in  `"GOVSURVEILLANCE"' `"AI-COMPLEMENTARY"'  { 
	...
	* col 1 and 2
	...
	addQuarterInter	
	regToCoefDataset90 blank 
	save "Data/Intermediate/FigA11_`pre'_`t'_dd.dta", replace
	...
	* col 1 and 2
	...
	addQuarterInter
	regToCoefDataset90 blank 
	save "Data/Intermediate/FigA11_`pre'_`t'_b1_dd.dta", replace
...
foreach t in  `"AI-COMPLEMENTARY"'  `"GOVSURVEILLANCE"' {
	use "Data/Intermediate/FigA11_`pre'_`t'_dd.dta", clear
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .3
	ren (beta top bottom) (beta_niv_b12 top_niv_b12 bottom_niv_b12)
	
	merge 1:1 id using "Data/Intermediate/FigA11_`pre'_hat_lasso_`t'_dd.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .1 if !missing(beta1)
	ren (beta1 top bottom) (beta_iv_b12 top_iv_b12 bottom_iv_b12)
	
	merge 1:1 id using "Data/Intermediate/FigA11_`pre'_`t'_b1_dd.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .1 if !missing(beta1)
	ren (beta1 top bottom) (beta_niv_b1 top_niv_b1 bottom_niv_b1)
	
	merge 1:1 id using "Data/Intermediate/FigA11_`pre'_hat_lasso_`t'_b1_dd.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .3 if !missing(beta1)
	ren (beta1 top bottom) (beta_iv_b1 top_iv_b1 bottom_iv_b1)
...
** different FEs, differetn outcomes
xpoivregress lead_police_pc (blank = c.(w1-w18)##c.(w1-w18) c.(wI1-wI18)##c.(wI1-wI18)), control((i.qofd i.place) prefecture_city_population pcp_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
** different FEs, differetn outcomes
xpoivregress lead_police_pc (blank = c.(w1-w18)##c.(w1-w18) c.(wI1-wI18)##c.(wI1-wI18)), control((i.qofd i.place) prefecture_fiscal_revenue pfr_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
** different FEs, differetn outcomes
xpoivregress lead_police_pc AI_stock_t2 (blank = c.(w1-w18)##c.(w1-w18) c.(wI1-wI18)##c.(wI1-wI18)), control((i.qofd i.place) prefecture_gdp gdp_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
** different FEs, differetn outcomes
xpoivregress lead_police_pc  AI_stock_t2 (blank = c.(w1-w18)##c.(w1-w18) c.(wI1-wI18)##c.(wI1-wI18)), control((i.qofd i.place) prefecture_gdp gdp_* prefecture_city_population pcp_* prefecture_fiscal_revenue pfr_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
** different FEs, differetn outcomes
xpoivregress `outcome' (blank = c.(w1-w18) c.(wI1-wI18)), control((i.qofd i.place) prefecture_gdp gdp_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
** different FEs, differetn outcomes
xpoivregress `outcome' (blank = c.(w1-w18) c.(wI1-wI18)), control((i.qofd i.place) prefecture_city_population pcp_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
** different FEs, differetn outcomes
xpoivregress `outcome' (blank = c.(w1-w18) c.(wI1-wI18)), control((i.qofd i.place) prefecture_fiscal_revenue pfr_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
** different FEs, differetn outcomes
xpoivregress `outcome'  AI_stock_t2 (blank = c.(w1-w18) c.(wI1-wI18)), control((i.qofd i.place) prefecture_gdp gdp_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
** different FEs, differetn outcomes
xpoivregress `outcome' AI_stock_t2 (blank = c.(w1-w18) c.(wI1-wI18)), control((i.qofd i.place) prefecture_gdp gdp_* prefecture_city_population pcp_* prefecture_fiscal_revenue pfr_*) vce(cl place) rseed(1)
est sto a`j'
}
local j = `j' + 1
...
merge n:1 firm_prov firm_pref qofd using `unrest', keep(1 3) nogen
	...
	*list beta1 se1 if beta1<. ,clean
	...
	save "Data/Intermediate/FigA16_PanelA_`t'.dta", replace
...
local pre = "event"
	...
	use "Data/Intermediate/FigA16_PanelA_ALL.dta", clear
	replace top = . if id == -1
	replace bottom = . if id == -1
	...
	merge 1:1 id using "Data/Intermediate/FigA16_PanelA_GOVERNMENT.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	...
	merge 1:1 id using "Data/Intermediate/FigA16_PanelA_BUSINESS.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .2 if !missing(beta1)
...
keep if inrange(quarter_to_first,-24,24) & place != 0 // balance the number of periods before and after, not missing place
	...
	regToCoefDataset90 blank 
	save "Data/Intermediate/FigA16_PanelB_`t'.dta", replace
...
local pre = "event"
	...
	use "Data/Intermediate/FigA16_PanelB_ALL.dta", clear
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .2 if !missing(beta1)
	ren (beta1 top bottom) (beta_a top_a bottom_a)
	...
	merge 1:1 id using "Data/Intermediate/FigA16_PanelB_GOVERNMENT.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .01 if !missing(beta1)
	ren (beta1 top bottom) (beta_g top_g bottom_g)
	...
	merge 1:1 id using "Data/Intermediate/FigA16_PanelB_BUSINESS.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .2 if !missing(beta1)
	ren (beta1 top bottom) (beta_b top_b bottom_b)
...
keep if inrange(quarter_to_first,-24,24) & place != 0 // balance the number of periods before and after, not missing place
	...
	regToCoefDataset90 blank 
	save "Data/Intermediate/FigA16_PanelC_`t'.dta", replace
...
local pre = "event"
	...
	use "Data/Intermediate/FigA16_PanelC_ALL.dta", clear
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .2 if !missing(beta1)
	ren (beta1 top bottom) (beta_a top_a bottom_a)
	
	merge 1:1 id using "Data/Intermediate/FigA16_PanelC_GOVERNMENT.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .01 if !missing(beta1)
	ren (beta1 top bottom) (beta_g top_g bottom_g)
	...
	merge 1:1 id using "Data/Intermediate/FigA16_PanelC_BUSINESS.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .2 if !missing(beta1)
	ren (beta1 top bottom) (beta_b top_b bottom_b)
...
tempname fh 
file open `fh' using "Data/Intermediate/FigA10_seeds.csv", write text replace
...
import delim "Data/Intermediate/FigA10_seeds.csv", clear	
...
foreach t in `"BUSINESS"'  {
	...
	* col 1 and 2
	...
	addQuarter24	
	regToCoefDataset90 blank 
	save "Data/Intermediate/FigA15_`pre'_`t'.dta", replace
...
local t = "BUSINESS"
local pre = "event"
	use "Data/Intermediate/FigA15_`pre'_`t'.dta", clear
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id - .1
	ren (beta top bottom) (beta_niv top_niv bottom_niv)
	
	merge 1:1 id using "Data/Intermediate/FigA15_`pre'_hat_lasso_`t'.dta", nogen
	replace top = . if id == -1
	replace bottom = . if id == -1
	replace id = id + .1
