...
log using ../../Results/log/czone_analysis_ipw_final.log, replace text

use ../../Data/dta/workfile_china.dta, clear
...
esttab using ../../Results/log/tab_ipw_manuf_2.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_ipw_pop.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t*) replace
...
esttab using ../../Results/log/tab_ipw_empl.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_ipw_wage.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_ipw_mfgnmfg.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_ipw_trans.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_ipw_hhinc_pw.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_expoff_iv.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_intermediates.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_nipw_iv.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_nipw_grav.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_ifactor_net_io.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_ipw_manuf_pre.scsv, b(%9.3f) se(%9.3f) nostar r2 replace
...
esttab using ../../Results/log/tab_ipw_manuf_exporters.scsv, b(%9.4f) se(%9.4f) nostar r2 drop(t* reg*) replace
...
esttab using ../../Results/log/tab_ipw_empl2.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t* reg*) replace
