...
log using ../../Results/log/czone_analysis_preperiod.log, replace text

use ../../Data/dta/workfile_china_preperiod.dta, clear
...
esttab using ../../Results/log/tab_ipw_mfg_byperiod.scsv, b(%9.3f) se(%9.3f) nostar r2 drop(t*) replace
