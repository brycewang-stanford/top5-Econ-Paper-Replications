...
log using ../../Results/log/czone_plot_import_long_final.log, replace text

use ../../Data/dta/workfile_china_long.dta, clear
...
msymbol(circle)
ylabel(-10(10)50)
saving(../../Results/Figures/mfg_imppw_9007long_2sls1_av.gph, replace);
#delimit cr
...
msymbol(circle)
saving(../../Results/Figures/mfg_imppw_9007long_olsred_av.gph, replace);
#delimit cr
