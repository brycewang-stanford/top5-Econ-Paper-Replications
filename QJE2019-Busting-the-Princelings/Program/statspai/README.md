...
| `modern_did.py` | **Extensions** (not replication) | `sp.bacon_decomposition`, `sp.callaway_santanna` + `sp.aggte`, `sp.sun_abraham`, `sp.did_imputation`, `sp.honest_did`, `sp.pretrends_power` | ~3 min |
