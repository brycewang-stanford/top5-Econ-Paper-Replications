* PATCHED COPY of Program/dofiles/Appendix_Table_A4_col9.do.
* Author bug: master_QJE.do calls this file without the 3 arguments it reads (w_upper w_lower w_increment) -> r(198).
* Fix: when no arguments are passed, use the defaults of finerabovebelowbunch in create_programs.do (500 400 25 cents),
* i.e. the 25-cent-increment treatment of Table A.4 column 9 (paper column label). Nothing else changed.
if `"`1'"' == "" {
	local 1 500
	local 2 400
	local 3 25
