* PATCHED COPY of dofiles/Appendix_Table_F3.do (replication project): the only change reads me_corrected_logwages.dta
* from ${data} (where the package ships it and where Appendix_Figure_F4.do reads it) instead of ${stn_bsamples}.
...
use "${data}me_corrected_logwages.dta", clear  // PATCH: shipped file lives in ${data}, not ${stn_bsamples}
