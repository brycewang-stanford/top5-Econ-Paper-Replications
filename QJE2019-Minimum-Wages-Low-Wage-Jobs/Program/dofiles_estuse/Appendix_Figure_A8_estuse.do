* ESTUSE COPY: identical to Program/dofiles/Appendix_Figure_A8.do except that the reghdfe and est save lines are
...
do "${dofiles}../dofiles_estuse/grouplevelanalysis_new_QJE_estuse.do"
