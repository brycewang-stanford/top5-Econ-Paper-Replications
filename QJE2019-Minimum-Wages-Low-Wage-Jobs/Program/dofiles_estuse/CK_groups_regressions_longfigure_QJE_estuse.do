* ESTUSE COPY generated by Program/run_original.do documentation: identical to Program/dofiles/CK_groups_regressions_longfigure_QJE.do
...
*ESTUSE* ${rtype`s'} `Y'countpc  ${treatafter}  if  year>=`b'  & cleansample==1 ${weight`Y'`b'} , a(${a`s'} ${controlbefore}  ${window} ${placebocontafter1} ${placebobefore1} ${windowpl1} ${placebocontafter2} ${placebobefore2} ${windowpl2} ${controlf}  ${control}  )  cluster(statenum)
*ESTUSE* est save "${estimates}CKforplacebofig_true`limitsample'`limittreat'_`s'_`Y'_`b'_w`w'_`temp1'_`temp2'_${Tmax}${Tmin}", replace 
...
*ESTUSE* ${rtype`s'} `Y'countpc ${placeboafter1} if  year>=`b'  & cleansample==1 ${weight`Y'`b'} , a(${a`s'} ${controlbefore}  ${controlafter}  ${window}  ${placebocontafter2} ${windowpl2}  ${placebobefore2} ${placebobefore1} ${windowpl1} ${controlf}  ${control}  )  cluster(statenum)
*ESTUSE* est save "${estimates}CKforplacebofig_pl1`limitsample'`limittreat'_`s'_`Y'_`b'_w`w'_`temp1'_`temp2'_${Tmax}${Tmin}", replace 
...
*ESTUSE* ${rtype`s'} `Y'countpc ${placeboafter2} if  year>=`b'  & cleansample==1 ${weight`Y'`b'} , a(${a`s'} ${controlafter}  ${controlbefore}  ${window} ${placebocontafter1}  ${placebobefore1} ${windowpl1} ${placebobefore2} ${windowpl2} ${controlf}  ${control}  )  cluster(statenum)
*ESTUSE* est save "${estimates}CKforplacebofig_pl2`limitsample'`limittreat'_`s'_`Y'_`b'_w`w'_`temp1'_`temp2'_${Tmax}${Tmin}", replace 
